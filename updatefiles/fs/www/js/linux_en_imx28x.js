...
function mmLoadMenus()
{
    ...
    window.mm_menu_0 = new Menu("root",132,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_1 = new Menu("root",138,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
 ...
 mm_menu_1.addMenuItem("GVRP","location='setup.cgi?next_file=gvrp_en.html'");
  mm_menu_1.addMenuItem("GMRP","location='setup.cgi?next_file=gmrp_en.html'");
    ...
    window.mm_menu_2 = new Menu("root",70,20,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_4 = new Menu("root",126,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_5 = new Menu("root",92,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_6 = new Menu("root",118,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_7 = new Menu("root",113,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
    ...
    window.mm_menu_8 = new Menu("root",94,18,"宋体, SimSun, NSimSun",12,"#000000","#FFFFFF","#CCCCCC","#999999","left","middle",3,0,1000,-5,7,true,true,true,0,true,true);
...
//-----------Main Menu hubo --------------------------------------------//
	 ...
	 //--------------- 主导航条内容 ------------//
     var mainLayer=new Array("System Status","Port Config","Link Layer","Link Backup","Access Control","Remote Monitor","Statistics","Network Diagnosis","Management");//主导航栏目
	 ...
	 var subLayer2=new Array("QoS","VLAN","MAC VLAN","VLAN MAP","IP VLAN","Pro VLAN","GVRP","GMRP","IGMP Snooping","Static Multicast List","LLDP","Portisolate","MAC ACL","IP ACL","Black&White Lists"); 
     var subLayerHttp2=new Array("setup.cgi?next_file=qos_en.html","setup.cgi?next_file=vlan_en.html","setup.cgi?next_file=mac_vlan_en.html","setup.cgi?next_file=vlan_map_en.html","setup.cgi?next_file=ip_vlan_en.html",
	     "setup.cgi?next_file=pro_vlan_en.html","setup.cgi?next_file=gvrp_en.html","setup.cgi?next_file=gmrp_en.html","setup.cgi?next_file=igmp_en.html","setup.cgi?next_file=fwd_en.html","setup.cgi?next_file=lldp_en.html","setup.cgi?next_file=proport_en.html",
